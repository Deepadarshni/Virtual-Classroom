...
public class VirtualClassroomManager {
	...
	public void addStudent(String studentID, String className) {
	    if (classrooms.containsKey(className)) {
	        ...
	        if (!classroom.getStudents().contains(studentID)) {
	            ...
	            System.out.println("Student " + studentID + " is already enrolled in " + className + ".");
	        }
	    } else {
	...
	// 3.Scheduling assignments for each classroom
	...
	// 4.Submission of assignments by students
	    ...
	    if (studentClassMap.containsKey(studentID) && studentClassMap.get(studentID).equals(className)) {
	        ...
	        if (classroom != null) {
	            if (classroom.getAssignments().contains(assignmentDetails)) {
	                ...
	                System.out.println("Assignment '" + assignmentDetails + "' is not scheduled for " + className + ".");
	            }
	        } else {
	            System.out.println("Classroom " + className + " does not exist.");
	        }
	...
	// 5.Displaying list of classrooms
	...
	// 6.Displaying list of students belonging to the same class
	...
	// 7. Removing existing classrooms
